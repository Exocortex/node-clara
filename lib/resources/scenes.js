...
module.exports = {
  ...
  hashupload: {
    ...
    options: {
      hashes: {type: Array, description: 'Array of file hashes', required: true}
    }
  },
  ...
  render: {
    ...
    query: {
      ...
      v2renderer: {type: Boolean, description: "Use v2 renderer for WebGL Renders"},
    },
    options: {
      ...
      configuration: {type: 'json', as: 'filename', description: 'Optional data for configuration'},
    },
    output: 'binary'
  },
